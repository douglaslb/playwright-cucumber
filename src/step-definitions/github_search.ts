...
Given('I open GitHub website', async function (this: World) {
...
When('I click on users tab', async function (this: World) {
  await this.page.locator('a:has-text("Users") >> nth=0').click()
})

When('I click on Douglas Lima name', async function (this: World) {
